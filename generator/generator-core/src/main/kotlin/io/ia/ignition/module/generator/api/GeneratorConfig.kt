...
data class GeneratorConfig constructor(
    ...
    /**
     * To fully customize build files such as buildscripts, settings, or gradle.properties.  Configured [BuildFile]s
     * will only be used if the [ProjectScope] of the `BuildFile` is a [ProjectScope.ROOT], or its scope is represented
     * in the [scopes] string.
     *
     * Acts as an override to the default BuildFiles that are generated by matching the ProjectScope and
     */
    val buildScriptFiles: Set<BuildFile> = emptySet()
